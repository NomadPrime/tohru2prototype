var PageLayout = {
	...
	MainScreen: '<div><table><tr><th rowspan="3"><img src="./images/TOHRU_Hand.png" height=80></th><td><p> </p></td></tr><tr><td valign="bottom"><span style="font-size: 30px">Trace Online Hand Raising Utility</span></td></tr><tr><td><span id="MOTD" style="font-size: 20px; color: #0000ff"></span></td></tr></table></div><div id="controls"></div><p><span style="background-color: #cccccc">Current Speaker: <span id="speaker"></span></span></p><div id="modcontrols"></div><div id="theList"></div>',
	controls: {
		main: '<p><input id="comment" type="text" style="font-size: 16px" size=100 value="Add a comment (optional)" onclick="this.value=\'\'"></p><p><button style="font-size: 16px" onclick="MainScreen.raise(\'S\');"><img src="./images/S_Icon.png" height=20>ame Topic</button><button style="font-size: 16px" onclick="MainScreen.raise(\'N\');"><img src="./images/N_Icon.png" height=20>ew Topic</button><button style="font-size: 16px" onclick="MainScreen.raise(\'A\');"><img src="./images/A_Icon.png" height=20>nswer to Question</button><button style="font-size: 16px" onclick="MainScreen.raise(\'P\');"><img src="./images/P_Icon.png" height=20>ropose Resolution</button></p>',
